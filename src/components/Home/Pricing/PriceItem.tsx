...
const PriceItem = ({ plan }: Props) => {
  ...
  return (
    <>
      ...
      >
        {active && (
          <span className="absolute right-4.5 top-4.5 inline-flex rounded-[5px] px-3 py-[5px] font-satoshi font-medium bg-white/10 text-white">
            Popular
          </span>
        )}
      ...
      {showModal && (
        ...
        >
          <div
            style={{ maxWidth: "1000px", marginTop: "5%" }}
            className="   w-full   bg-white rounded-lg  mx-2"
          ...
          >
            ...
            <div style={{ marginBottom: "10px" }}>
              {pricingData && <PaymentInterface plan={plan} />}{" "}
            </div>
          </div>
        </div>
      )}
